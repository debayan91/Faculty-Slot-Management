...
export function CourseRegistration() {
  ...
  return (
    <>
      <nav className="w-full max-w-4xl flex justify-between items-center py-6 mb-8 border-b">
        <div className="text-xl font-medium">Faculty Portal</div>
        <ThemeToggle />
      </nav>

      <Card className="w-full max-w-2xl shadow-lg" style={{boxShadow: '0 4px 25px hsl(var(--ring) / 0.15)'}}>
